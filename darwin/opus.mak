...
$(BUILD_DIR)/$(1):
	bash $(MAKEFILE_DIR)configure-opus-$(1).sh $(GENERATOR) $(BUILD_DIR)/$(1) $(SOURCE_DIR) $(INSTALL_DIR)/$(1)
...
build-$(1): config-$(1) $(BUILD_DIR)/$(1)/$(CONFIG)/libopus.a
...
install-$(1): build-$(1) $(INSTALL_DIR)/$(1)
